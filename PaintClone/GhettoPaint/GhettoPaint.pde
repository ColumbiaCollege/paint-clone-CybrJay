...
//Declares and initializes integer datatypes for red, green, blue colors
int red = 0;
int green = 0;
int blue = 0;

//Method used to declare initial code
void setup() {
...
//Method that's declared after setup to continuously run lines of code 
void draw() {
  //noStroke function that disables the outline of a shape or line
  noStroke();
  ...
  //if statement that's used with the mousePressed boolean to change the color if the mouse is pressed, and to contain the coordinates of the mouseX and mouseY variables 
  ...
  //Function used to print the red variable
  println(red);
  ...
  //Function used to print the green variable
  println(green);
  ...
  //Function used to print the blue variable
  println(blue);

  //if statement that's using the mousePressed boolean to draw the color is the mouse is pressed
  if (mousePressed) {
